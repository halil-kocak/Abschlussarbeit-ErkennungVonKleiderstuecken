...
\begin{center}
	$f(x) = max(0,x)$, wobei x der Eingangswert ist. Sie beschreibt seinen Argument als Positivteil.
\end{center}
...
\begin{figure}[h!]
	\centering
	\includegraphics[width=12cm,height=8cm]		{ExperimentModelAufbau_1.png}
	\caption{ Experiment 1: Modellaufbau \cite{}}
	\label{fig:fig13}
\end{figure}
