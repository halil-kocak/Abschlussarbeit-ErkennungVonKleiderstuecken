...
\begin{figure}[h!]
	\centering
	\includegraphics[width=13cm,height=15cm]		{ExperimentModelTrainingsphase_3.png}
...
Dabei wird die Feature Extraktion drei mal Angewendet. Die Schicht BatchNormalization wird statt unseren MaxPooling Layer im Modell benützt. 
